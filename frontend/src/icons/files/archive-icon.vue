<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
    ...
    <g transform="translate(9,11)">
      <path d="M7 0 14 3v7l-7 3-7-3V3L7 0z" fill="#F59E0B"/>
      <path d="M7 0 0 3l7 3 7-3-7-3z" fill="#FDBA74"/>
      <path d="M7 6v7" stroke="#92400E" stroke-linecap="round"/>
    </g>

    <!-- Bottom banner -->
    <rect x="5.5" y="22.25" width="21" height="4.75" rx="1.2" fill="#F59E0B"/>
    <text x="16" y="24.6" font-family="Segoe UI, Roboto, Arial, Helvetica, sans-serif" font-size="3.6" font-weight="800" text-anchor="middle" dominant-baseline="middle" fill="#FFFFFF" stroke="#000" stroke-opacity=".2" stroke-width=".25" paint-order="stroke fill">ZIP</text>
  </svg>
</template>

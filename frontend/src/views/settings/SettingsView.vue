...
<template>
  <div class="flex h-full w-full flex-col">
    <!-- Header -->
    <header
      class="flex items-center gap-3 border-b border-neutral-200 bg-white/80 px-4 py-3 backdrop-blur
    ...
    <div class="flex flex-1 flex-col overflow-hidden md:flex-row">
      ...
      <aside
        class="border-b border-neutral-200 bg-neutral-50/80 px-4 py-3 text-sm
        dark:border-neutral-700 dark:bg-neutral-900/40
        md:w-64 md:flex-shrink-0 md:border-b-0 md:border-r md:px-5 md:py-4"
      >
          ...
          <section>
            ...
            <nav class="flex gap-2 overflow-x-auto pb-1 md:flex-col md:gap-1 md:overflow-visible md:pb-0">
              <button
                ...
                :key="c.key"
                type="button"
                class="flex min-w-[160px] items-center gap-2 rounded-lg border border-neutral-200/70 bg-white/80 px-3 py-2 text-left text-sm text-neutral-700 shadow-sm transition
                hover:bg-white
                dark:border-neutral-700/70 dark:bg-neutral-800/80 dark:text-neutral-200 dark:hover:bg-neutral-700/80

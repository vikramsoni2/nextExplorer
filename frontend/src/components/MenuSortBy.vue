      ...
      >
        <div class="flex flex-col gap-1 p-1">
          <button
            ...
            :key="option.key"
            @click="
              settings.setSortBy(option.key);
              menuOpen = false;
            "
            class="flex items-center gap-1 p-0.5 px-2 rounded-md text-left hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600 dark:active:bg-blue-600 dark:focus:bg-blue-600"

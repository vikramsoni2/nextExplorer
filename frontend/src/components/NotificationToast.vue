<script setup>
import { XMarkIcon, CheckCircleIcon, XCircleIcon, InformationCircleIcon, ExclamationTriangleIcon } from '@heroicons/vue/24/outline'
...
<template>
  <div
    class="pointer-events-auto w-full max-w-sm overflow-hidden rounded-xl
           bg-white/95 dark:bg-zinc-900/90 shadow-2xl ring-1 ring-black/10 dark:ring-white/20
           border border-neutral-200/80 dark:border-white/10 backdrop-blur-md">
    <div class="p-4">

...
nextExplorer is configured almost entirely through environment variables. The backend (`apps/api/src/config/env.js`) centralizes the defaults you see here. Use this reference when you want to tune ports, paths, auth, integrations, or feature flags.

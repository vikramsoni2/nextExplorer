 ...
 */
router.get('/users/:userId/volumes', volumeMiddleware, asyncHandler(async (req, res) => {
 ...
 */
router.post('/users/:userId/volumes', volumeMiddleware, asyncHandler(async (req, res) => {
  const { userId } = req.params;
 ...
 */
router.patch('/users/:userId/volumes/:volumeId', volumeMiddleware, asyncHandler(async (req, res) => {
 ...
 */
router.delete('/users/:userId/volumes/:volumeId', volumeMiddleware, asyncHandler(async (req, res) => {
  const { userId, volumeId } = req.params;
 ...
 */
router.get('/admin/browse-directories', volumeMiddleware, asyncHandler(async (req, res) => {
